                  ...
                  child: Column(
                      ...
                      ReuseAbleClass().buildOptionRow(
                        [
                          ReuseAbleClass().buildIconButton(
                              ...
                              () async {
                            await onTouch.showBorderContainerFlag('barcode', false);
                          }),
                    ...
                    _buildTextIonButton('assets/icons/redo.png', 'Redo', () {}),*/
                          ReuseAbleClass().buildTextIonButton(
                            ...
                            onTouch.rotateFunction(barCodesContainerRotations, selectedBarCodeIndex);
                          }),
                        ],
                      ),
                                      ...
                                      builder: (context, setState) {
                                        return Container(
                                          ...
                                          child: EncodingTypePicker(
                                            selectedType:
                                                barcodeModel.encodingType,
                                            supportedTypes: barcodeModel
