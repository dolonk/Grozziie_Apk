...
import 'package:grozziieapk/ui/create_label/my_app_bar.dart';
import 'package:grozziieapk/ui/create_label/my_bottom_app_bar.dart';
...
class _CreateLabelState extends State<CreateLabel> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Column(
        children: [
          createdLabelContainer(containerHeight, containerWidth, context),
...
bool barcodeIconBorder = false;

// Qrcode Border
bool qrcodeBorderWidget = false;
bool qrcodeIconBorder = false;

//Icon widget
bool emojiIconBorderWidget = false;
bool emojiIconBorder = false;

//Time widget
bool timeBorderWidget = false;
bool timeIconBorder = false;
*/
